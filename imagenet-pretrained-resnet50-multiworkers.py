...
train_dataset = train_dataset.batch(32*n_workers, drop_remainder=True)
train_dataset = train_dataset.prefetch(buffer_size=tf.data.AUTOTUNE)
validation_dataset = validation_dataset.batch(32*n_workers, drop_remainder=True)
...
with strategy.scope():
    ...
    model = keras.Model(inputs=inputs, outputs=outputs, name="ResNet50_Pretrained_ImageNet_Multiworkers")
